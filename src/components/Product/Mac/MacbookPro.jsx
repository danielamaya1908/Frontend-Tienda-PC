    ...
    const fetchMacProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('http://localhost:3005/products/category/Computación/subcategory/MacBook/name/MacBook%20Pro%20de%2013%20pulgadas'),
          axios.get('http://localhost:3005/products/category/Computación/subcategory/MacBook/name/MacBook%20Pro%20de%2014%20pulgadas'),
          axios.get('http://localhost:3005/products/category/Computación/subcategory/MacBook/name/MacBook%20Pro%20de%2016%20pulgadas')
        ]);
  ...
  return (
    <div className="mac-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4">Macbook Pro</h1>
