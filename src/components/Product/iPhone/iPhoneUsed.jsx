...
const IphoneUsed = () => {
  ...
  useEffect(() => {
    const fetchIphoneProducts = async () => {
      try {
        const response = await axios.get('http://localhost:3005/products/category/Smartphones/subcategory/iPhone/name/iPhone%20SE%20(3.ª generación)');
