    ...
    const fetchIphoneProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('http://localhost:3005/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015'),
          axios.get('http://localhost:3005/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015%20Plus')
        ]);
