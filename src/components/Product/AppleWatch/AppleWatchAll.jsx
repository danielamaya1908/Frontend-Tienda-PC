...
const AppleWatchAll = () => {
  ...
  useEffect(() => {
    const fetchAppleWatchProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Smartwatches%20y%20accesorios/subcategory/Smartwatches');
  ...
  return (
    <div className="apple-watch-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4">Apple Watches</h1>
