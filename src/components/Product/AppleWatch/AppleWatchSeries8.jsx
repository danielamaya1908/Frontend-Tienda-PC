...
const AppleWatchSeries8 = () => {
  ...
  useEffect(() => {
    const fetchAppleWatchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:3005/products/category/Smartwatches%20y%20accesorios/subcategory/Smartwatches/name/Apple%20Watch%20Series%208');
