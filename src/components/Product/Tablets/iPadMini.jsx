...
const IpadMini = () => {
  ...
  useEffect(() => {
    const fetchIpadProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Computación/subcategory/Tablets/name/iPad%20mini%20Wi-Fi-%206.ª%20generación');
