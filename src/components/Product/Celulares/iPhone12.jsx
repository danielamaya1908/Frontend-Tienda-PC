...
const Iphone12 = () => {
  ...
  useEffect(() => {
    const fetchIphoneProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Smartphones/subcategory/iPhone/name/iPhone%2012');
  ...
  return (
    <div className="iphone-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4" style={{ color: 'black' }}>iPhone 12</h1>
