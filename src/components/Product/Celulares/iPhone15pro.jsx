    ...
    const fetchIphoneProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015%20Pro'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015%20Pro%20Max')
        ]);
              ...
              <div className="card h-100 small-card">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <div className="mt-auto d-flex justify-content-between">
                    <Link to={`/detalle-producto/${product.id}`} className="btn btn-primary btn-sm">Comprar</Link>
                  </div>
                </div>
              </div>
            </div>
