    ...
    const fetchSonidoProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('http://localhost:3005/products/category/Accesorios%20de%20audio/subcategory/Parlantes'),
          ...
          axios.get('http://localhost:3005/products/category/Parlantes/subcategory/Parlante%20Portátil')
        ]);
