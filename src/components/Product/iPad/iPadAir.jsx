    ...
    const fetchIpadProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('http://localhost:3005/products/category/Computación/subcategory/Tablets/name/iPad%20Air'),
          axios.get('http://localhost:3005/products/category/Computación/subcategory/Tablets/name/iPad%20Air%20de%2011%20pulgadas%20M2'),
          axios.get('http://localhost:3005/products/category/Computación/subcategory/Tablets/name/iPad%20Air%20de%2013%20pulgadas%20M2')
        ]);
