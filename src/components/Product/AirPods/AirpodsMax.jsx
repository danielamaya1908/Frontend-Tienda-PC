...
const AirpodsMax = () => {
    ...
    const fetchAirpodsProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('http://localhost:3005/products/category/Audifonos/subcategory/Auriculares/name/AirPods%20Max')
        ]);
  ...
  return (
    <div className="airpods-max-products">
      <Navbar />
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4">Airpods Max</h1>
