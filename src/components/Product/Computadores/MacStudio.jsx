...
const MacStudio = () => {
  ...
  useEffect(() => {
    const fetchMacProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Computación/subcategory/Mac%20studio');
  ...
  return (
    <div className="mac-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4">Mac Studio</h1>
